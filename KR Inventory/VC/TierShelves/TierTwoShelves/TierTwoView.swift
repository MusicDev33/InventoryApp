...
class TierTwoView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        shelfTable.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 50).isActive = true
